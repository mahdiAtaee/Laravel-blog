    ...
    <div class="row justify-content-between align-items-center mb-2">
        ...
        <div class="col-12 col-lg-auto mb-3">
            <div class="page-heading">
                <h3 class="title">داشبورد <span>/ کاربران</span></h3>
            </div>
    ...
    <div class="col-lg-12 col-12 mb-4" dir='rtl'>
        <div class="box">
            <div class="box-head d-flex align-items-center justify-content-between">
                ...
                <a href="{{route('create.user')}}" class="btn btn-secondry">ایجاد کاربر جدید</a>
            </div>
            <div class="box-body">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td class="controll">
                                <a href="{{route('edit.user',$User-> id)}}" class="btn btn-warning btn-sm">ویرایش</a>
                                <a href="{{route('destroy.user',$User-> id)}}" class="btn btn-danger btn-sm" onclick="return confirm('آیا مطمِن هستید؟')">حذف</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
